    ...
    _OP_DEF(opexe_6, "dir-list",                       1,  1,       TST_NONE,                        OP_DIR_LIST         )
    ...
    _OP_DEF(opexe_6, "apply-transform",                0,  0,       0,                               OP_APPLY_TRANSFORM  )
    _OP_DEF(opexe_6, "clear",                          0,  0,       0,                               OP_CLEAR            )
    _OP_DEF(opexe_6, "clear-colour",                   1,  1,       0,                               OP_CLEAR_COLOUR     )
    _OP_DEF(opexe_6, "pdata-size",                     0,  0,       0,                               OP_PDATA_SIZE       )
    _OP_DEF(opexe_6, "pdata-add",                      1,  1,       0,                               OP_PDATA_ADD        )
